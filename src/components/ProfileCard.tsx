    ...
    <div className="p-4 bg-white rounded-lg shadow-md text-sm flex flex-col gap-6">
      ...
      <div className="h-20 flex flex-col gap-2 items-center">
        ...
        <div className="flex items-center gap-4">
            <div className="flex">
            <Image src="https://i.pinimg.com/736x/5d/7c/d8/5d7cd8f02d391448b68bbe847f5cf1a9.jpg" alt="" width={12} height={12} className="rounded-full object-cover w-3 h-3"/>  
            <Image src="https://i.pinimg.com/736x/5d/7c/d8/5d7cd8f02d391448b68bbe847f5cf1a9.jpg" alt="" width={12} height={12} className="rounded-full object-cover w-3 h-3"/>  
            <Image src="https://i.pinimg.com/736x/5d/7c/d8/5d7cd8f02d391448b68bbe847f5cf1a9.jpg" alt="" width={12} height={12} className="rounded-full object-cover w-3 h-3"/>  
            </div>
            <span className="text-xs text-gray-500">{user._count.followers} Seguidores</span>
        </div>
        <Link href={`/profile/${user.username}`}>
          <button className="bg-blue-500 text-white text-xs p-2 rounded-md">Mi perfil</button>
        </Link>
      </div>
    </div>
  )
