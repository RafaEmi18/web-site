...
const PostInteraction = ({postId, likes, commentNumber} : {postId: number; likes: string[]; commentNumber: number;}) => {
    ...
    const likeAction = async () => {
        ...
        try{
            ...
            console.error("Error al realizar la acción de 'me gusta':", err);
        }
    }
    ...
    return (
        <div className='flex items-center justify-between text-sm my-4'>
            ...
            <div className="flex items-center gap-4 bg-slate-50 p-2 rounded-xl">
                ...
                <span className='text-gray-300'>|</span>
                <span className='text-gray-500'>{commentNumber}<span className='hidden md:inline'> Comentarios</span> </span>
            </div>
            </div>
            <div className="">
